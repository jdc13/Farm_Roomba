...
RS_1080P = 2
class RealSense:
    def __init__(self, Device, Resolution, enable_depth=False):                                         #I like the additional settings here. Specifically resolution. I could also add a dispairity shift parameter
        ...
        if Resolution == RS_720P:
            ...
            rgbSize = [1920, 1080]
            depthSize = [1280, 720]     # depth camera only allows upto 720P                            #If this is the case than having resolution isn't helpful
        else:
            rgbSize = [640, 480]
            depthSize = [640, 480]
        ...
        try:
            self.device = self.profile.get_device()                                                     #I don't see the need for this
        ...
        #grab 2 seconds of frames to deal with first few frames being bad.                              #Probably something to grab
        numFrames = 2 * 30
    ...
    # Functions for accessing IMU data                                                                  #I don't think our camera has the IMU
